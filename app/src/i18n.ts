...
const fr = {
  ...
  streamDown: 'Le flux ne répond plus malgré plusieurs tentatives.',
  streamDenied: 'Accès refusé par le fournisseur : limite de connexions atteinte, abonnement expiré ou chaîne bloquée.',
  codecUnsupported: 'Cet appareil ne sait pas décoder la vidéo de ce flux (codec HEVC/H.265 ou similaire).',
...
const en: Dict = {
  ...
  streamDown: 'The stream stopped responding after several attempts.',
  streamDenied: 'Access refused by the provider: connection limit reached, subscription expired or channel blocked.',
  codecUnsupported: 'This device cannot decode the video of this stream (HEVC/H.265 or similar codec).',
